...
<main>
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        <center><h1>404</h1>
        <center><h2>UH OH! You're lost.</h2>
        <center><p>The page you are looking for does not exist.
          How you got here is a mystery. But you can click the button below
          to go back to the homepage.
        </p>
        <center><a class="btn btn-primary" href="https://macwaneric.github.io/" role="button">HOME</a>
      </div>
    </div>
  </div>
</main>